            ...
            <div className="container mx-auto px-6 pt-28">
                <div className="xl:-mx-8 xl:flex xl:items-center">
                    <div className="flex flex-col items-center xl:mx-8 xl:items-start">
                        <h1 className="text-3xl font-medium capitalize text-gray-800 dark:text-white lg:text-4xl">Our Pricing Plan</h1>
                        ...
                        <p className="mt-4 font-medium text-gray-500 dark:text-gray-300">You can get All Access by selecting your plan!</p>

                        <a href="#" className="-mx-1 mt-4 flex items-center text-sm capitalize text-gray-700 hover:text-blue-600 hover:underline dark:text-blue-400 dark:hover:text-blue-500">
                            <span className="mx-1">read more</span>
                            <svg className="mx-1 h-4 w-4 rtl:-scale-x-100" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                        </a>
                    </div>
                    ...
                    <div className="flex-1 xl:mx-8">
                        <div className="mt-8 space-y-8 md:-mx-4 md:flex md:items-center md:justify-center md:space-y-0 xl:mt-0">
                            <div className="mx-auto max-w-sm rounded-lg border dark:border-gray-700 md:mx-4">
                                <div className="p-6">
                                    <h1 className="text-xl font-medium capitalize text-gray-700 dark:text-white lg:text-3xl">Essential</h1>

                                    <p className="mt-4 text-gray-500 dark:text-gray-300">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nostrum quam voluptatibus</p>

                                    <h2 className="mt-4 text-2xl font-medium text-gray-700 dark:text-gray-300 sm:text-4xl">$3.00 <span className="text-base font-medium">/Month</span></h2>
                                ...
                                <div className="p-6">
                                    <h1 className="text-lg font-medium capitalize text-gray-700 dark:text-white lg:text-xl">What’s included:</h1>
                            ...
                            <div className="mx-auto max-w-sm rounded-lg border dark:border-gray-700 md:mx-4">
                                <div className="p-6">
                                    <h1 className="text-xl font-medium capitalize text-gray-700 dark:text-white lg:text-3xl">Premium</h1>

                                    <p className="mt-4 text-gray-500 dark:text-gray-300">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nostrum quam voluptatibus</p>

                                    <h2 className="mt-4 text-2xl font-medium text-gray-700 dark:text-gray-300 sm:text-4xl">$50.00 <span className="text-base font-medium">/life time</span></h2>
            ...
            <div className="container mx-auto px-6 py-20">
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
                    <div className="sm:col-span-2">
                        <h1 className="max-w-lg text-3xl font-semibold tracking-tight text-gray-800 dark:text-white xl:text-4xl">Subscribe our newsletter to get update.</h1>

                        <div className="mx-auto mt-8 flex flex-col space-y-3 md:flex-row md:space-y-0">
                            <input id="email" type="text" className="rounded-md border bg-white px-4 py-2 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-blue-300" placeholder="Email Address" />

                            <button className="w-full transform rounded-lg bg-gray-800 px-6 py-2.5 text-sm font-medium tracking-wider text-white transition-colors duration-300 hover:bg-gray-700 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-80 md:mx-4 md:w-auto">Subscribe</button>
                        </div>
                    </div>
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="-mx-2 flex">
                        ...
                        <a href="#" className="mx-2 text-gray-600 transition-colors duration-300 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400" aria-label="Github">
                            <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
