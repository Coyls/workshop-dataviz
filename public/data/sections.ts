...
export const CONTENT = [
    {
        ...
        intro: "Carl, un jeune collégien de 14 ans se rend comme tous les matins à son arrêt de bus. Il rencontre Anna, une adulte de 35 ans en situation de handicap moteur.",
    ...
    },
    {
        ...
        bigTitle: "Le labyrinthe à escaliers : le métro quand on est atteint d’handicap moteur.",
        canvas: {
            canvasWidth: 2560,
            canvasHeight: 1440,
            frameCount: 141,
